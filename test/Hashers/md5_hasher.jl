#
# @description Unit tests for MD5 hash algorithm.
#
...
#
@testset "MD5 hasher tests" begin
  @test MD5_DIGEST_SIZE          == 16
  @test digest_size(Md5Hasher()) == 16
  ...
  @test digest(Md5Hasher(), "a") == [ 0x0c, 0xc1, 0x75, 0xb9, 0xc0, 0xf1, 0xb6, 0xa8, 0x31, 0xc3, 0x99, 0xe2, 0x69, 0x77, 0x26, 0x61 ]

  @test hexdigest(Md5Hasher(), "abc")                        == "900150983cd24fb0d6963f7d28e17f72"
  @test hexdigest(Md5Hasher(), "message digest")             == "f96b697d7cb7938d525a2f31aaf161d0"
